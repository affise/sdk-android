...
class PostBackModelToJsonStringConverterTest {
    ...
    @Test
    fun convert() {
        val testData = "[{\"country\":\"test\",\"hardware_name\":\"test\"," +
            "\"app_version\":\"test\",\"reftoken\":\"test\",\"isp\":\"test\"," +
            "\"aff_device_id\":\"test\",\"affise_sdk_pos\":\"test\",\"mac_sha1\":\"test\"," +
            "\"language\":\"test\",\"device_type\":\"test\",\"fireos_adid\":\"test\"," +
            "\"uuid\":\"test\",\"aff_session_count\":\"test\",\"oaid_md5\":\"test\"," +
            "\"android_id_md5\":\"test\",\"cpu_type\":\"test\",\"affsdk_secret_id\":\"test\"," +
            "\"affpart_param_name\":\"test\",\"affise_pkg_app_name\":\"test\"," +
            "\"aff_deeplink\":\"test\",\"lifetime_session_count\":\"test\"," +
            "\"app_version_raw\":\"test\",\"reftokens\":\"test\",\"mccode\":\"test\"," +
            "\"last_time_session\":\"test\",\"affise_app_token\":\"test\",\"mac_md5\":\"test\"," +
            "\"aff_event_name\":\"test\",\"deeplink_click\":\"test\",\"mncode\":\"test\"," +
            "\"region\":\"test\",\"installed_time\":\"test\",\"gaid_adid_md5\":\"test\"," +
            "\"installed_hour\":\"test\",\"first_open_time\":\"test\"," +
            "\"affalt_device_id\":\"test\",\"aff_event_token\":\"test\"," +
            "\"random_user_id\":\"test\",\"affise_app_id\":\"test\"," +
            "\"device_manufacturer\":\"test\",\"platform\":\"test\",\"api_level_os\":\"test\"," +
            "\"device_name\":\"test\",\"adid\":\"test\",\"time_session\":\"test\"," +
            "\"aff_sdk_version\":\"test\",\"device_atlas_id\":\"test\",\"gaid_adid\":\"test\"," +
            "\"oaid\":\"test\",\"user_agent\":\"test\",\"install_finish_time\":\"test\"," +
            "\"connection_type\":\"test\",\"proxy_ip_address\":\"test\",\"altstr_adid\":\"test\"," +
            "\"os_version\":\"test\",\"last_session_time\":\"test\",\"timezone_dev\":\"test\"," +
            "\"affpart_param_name_token\":\"test\",\"store\":\"test\",\"label\":\"test\"," +
            "\"referral_time\":\"test\",\"referrer\":\"test\",\"coloros_adid\":\"test\"," +
            "\"install_begin_time\":\"test\",\"first_open_hour\":\"test\",\"os_name\":\"test\"," +
            "\"network_type\":\"test\",\"android_id\":\"test\"}]"
