...
dependencies {
  // Add Affise library 
  implementation("com.affise:attribution:1.6.39")
  // Add Affise modules 
  implementation("com.affise:module-advertising:1.6.39")
  implementation("com.affise:module-androidid:1.6.39")
  implementation("com.affise:module-link:1.6.39")
  implementation("com.affise:module-network:1.6.39")
  implementation("com.affise:module-phone:1.6.39")
  implementation("com.affise:module-status:1.6.39")
...
dependencies {
    // ...
    // Add Affise library 
    implementation(files("libs/attribution-1.6.39.aar"))
    // Add Affise modules 
    implementation(files("libs/module-advertising-1.6.39.aar"))
    implementation(files("libs/module-androidid-1.6.39.aar"))
    implementation(files("libs/module-link-1.6.39.aar"))
    implementation(files("libs/module-network-1.6.39.aar"))
    implementation(files("libs/module-phone-1.6.39.aar"))
    implementation(files("libs/module-status-1.6.39.aar"))
    // Add install referrer
    implementation("com.android.installreferrer:installreferrer:2.2")
}
```
